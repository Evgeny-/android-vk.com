angular.module('App').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/main-lentach.html',
    ...
    "            <div>\n" +
    "               <i class=\"icon--posts\"></i><br>Новости\n" +
    ...
    "      </tr>\n" +
    "      <tr>\n" +
    "         <td class=\"bl\" ng-click=\"openMail('oldlentach@gmail.com')\">\n" +
    "            <div>\n" +
    "               <i class=\"icon--mail\"></i><br>Связь\n" +
  ...
  $templateCache.put('views/menu-lentach.html',
    ...
    "            Новости <span ng-if=\"new.posts\" ng-bind=\"new.posts\"></span>\n" +
    "         </a>\n" +
    "      </li>\n" +
    "      <li><a ng-click=\"openPage('/saved')\">Избранное</a></li>\n" +
    "      <li>\n" +
    "         <a ng-click=\"openMail('oldlentach@gmail.com')\" ng-class=\"{new: new.photos}\">\n" +
    "            Связь\n" +
    "         </a>\n" +
    "      </li>\n" +
  ...
  $templateCache.put('views/pages-view.html',
    "<div ng-controller=\"PagesViewController\" id=\"photos-view\" class=\"page\" ng-show=\"title\">\n" +
    "   <div>\n" +
    "      <table class=\"header\">\n" +
    "         <tr>\n" +
    "            <td class=\"title\">\n" +
    "               <div class=\"sub-title\" ng-bind=\"title\"></div>\n" +
    "            </td>\n" +
    "            <td class=\"close\">\n" +
    "               <a ng-click=\"closePage()\"><i class=\"icon-cancel-1\"></i></a>\n" +
    "            </td>\n" +
    "         </tr>\n" +
    "      </table>\n" +
    "\n" +
